...
?>
    ...
    <style type="text/css">
        ...
        src: url('<?php echo $URL_S3; ?>fonts/OpenSans-Semibold-webfont.eot?');
        src: local('☺'),
        url('<?php echo $URL_S3; ?>fonts/OpenSans-Semibold-webfont.eot?#iefix') format('embedded-opentype'),
        url('<?php echo $URL_S3; ?>fonts/OpenSans-Semibold-webfont.woff2') format('woff2'),
        url('<?php echo $URL_S3; ?>fonts/OpenSans-Semibold-webfont.woff') format('woff'),
        url('<?php echo $URL_S3; ?>fonts/OpenSans-Semibold-webfont.ttf')format('truetype'),
        url('<?php echo $URL_S3; ?>fonts/OpenSans-Semibold-webfont.svg#OpenSans-Semibold-webfont') format('svg');
        font-weight: 500;
        font-style: normal;
        }
        @font-face
        ...
        src: url('<?php echo $URL_S3; ?>fonts/OpenSans-Bold-webfont.eot');
        src: local('☺'),
        url('<?php echo $URL_S3; ?>fonts/OpenSans-Bold.eot?#iefix') format('embedded-opentype'),
        ...
        .menu a.withArrow:after, .bio .loadMore:after, .projects .titleFieldset:after, .projects .loadMore:after, .projects .iconBlock .radioHiddenChoice + label div.description:before, nav.searchExplorer .containerInput:before
        {
            background-image: url(<?php echo $URL_S3; ?>images/sprite.png)
        }
