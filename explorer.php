...
<body id="home">
  ...
  <article class="grid-container full projects cguContainer">
    ...
    <div id="post_grid" class="grid-container">
      ...
      <h2> CHERCHER SON PROJET SELON.. </h2>
      ...
      <div class="grid-x grid-margin-x align-center blockProjects">
        ...
        <div class="small-12 medium-4 large-2 cell">
          <div class="title">Montant collecté</div>
          <div class="description_filter">
        ...
        <div class="small-12 medium-4 large-2 cell">
          <div class="title">Echéance</div>
          <div class="description_filter">
            <a href="#">Ordre croissant</a><br />
            <a href="#">Ordre décroissant</a><br />
          </div>
        </div>
        <div class="small-12 medium-4 large-2 cell iconBlock">
          <input type="radio" id="test200" class="radioHiddenChoice" name="test19" />
          <label for="test200">
            <div class="gd-triangle"></div>
            <div class="description">Sponsorisé</div>
          </label>
        ...
        <div class="small-12 medium-4 large-2 cell iconBlock">
          ...
          <label for="test201">
            <div class="gd-square"></div>
            <div class="description">Parrainé par un média</div>
          </label>
          </a>
        </div>
        <div class="small-12 medium-4 large-2 cell iconBlock">
          ...
          <label for="test202">
            ...
            <div class="description">Parrainé par une association</div>
          </label>
          </a>
        </div>
      </div>
      ...
      <div class="grid-x grid-margin-x align-center blockCategoryProjects">
        ...
        <div class="small-6 medium-4 large-auto cell">
          ...
          <label for="test186">
            <div class="container">
              <div class="gd-artistique iconCategory"></div>
            </div>
            <p> Artistique </p>
          </label>
        ...
        <div class="small-6 medium-4 large-auto cell">
          ...
          <label for="test185">
            <div class="container">
              <div class="gd-sportif iconCategory"></div>
            </div>
            <p> Sportif </p>
          </label>
        </div>
        ...
        <div class="small-6 medium-4 large-auto cell">
          ...
          <label for="test184">
            <div class="container">
              <div class="gd-professionnel iconCategory"></div>
            </div>
            <p> Professionnel </p>
          </label>
        </div>
        ...
        <div class="small-6 medium-4 large-auto cell">
          ...
          <label for="test183">
            <div class="container">
              <div class="gd-aventurier iconCategory"></div>
            </div>
            <p> Aventurier </p>
          </label>
        </div>
        ...
        <div class="small-6 medium-4 large-auto cell">
          ...
          <label for="test182">
            <div class="container">
              <div class="gd-solidaire iconCategory"></div>
            </div>
            <p> Solidaire </p>
          </label>
        </div>
        ...
        <div class="small-6 medium-4 large-auto cell">
          ...
          <label for="test181">
            <div class="container">
              <div class="gd-eco iconCategory"></div>
            </div>
            <p> Eco-responsable </p>
          </label>
      ...
      <div class="grid-x grid-margin-x align-center small-up-1 medium-up-2 large-up-3 post_grid_white">
        ...
        <div class="cell pad_cell">
          <div class="callout1">
            ...
            <div class="progress" role="progressbar" tabindex="0" aria-valuenow="1" aria-valuemin="0" aria-valuetext="25 percent"
              aria-valuemax="100">
            ...
            <div class="more_details grid-container">
              <div class="grid-x align-justify">
                ...
                <div class="cell small-4 postGridIconsBottom groupsIcon">
  ...
  <script type="text/javascript">
    function openFilter(data) {
      if ($(data).next('.description_filter').css('display') != 'none') {
        $(data).next('.description_filter').slideUp();
      } else {
        $(data).next('.description_filter').slideDown();
      }
